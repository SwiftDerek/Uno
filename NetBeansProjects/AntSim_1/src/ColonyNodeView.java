...
public class ColonyNodeView extends JPanel
{
    ...
    public int pheromoneCount = 0;
    public ArrayList<Ant> balaID = new ArrayList<>();
    public ArrayList<Ant> scoutID = new ArrayList<>();
    public ArrayList<Ant> foragerID = new ArrayList<>();
    public ArrayList<Ant> soldierID = new ArrayList<>();
	...
	public void hideForagerIcon()
	{
        ...
        public int getForagerCount(){
            return foragerID.size();
        }
        
        public int getSoldierCount(){
            return soldierID.size();
        }
